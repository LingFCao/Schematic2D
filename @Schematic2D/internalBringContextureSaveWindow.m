function internalBringContextureSaveWindow( obj )
% configurate a 'save' window
...
if ~isempty( obj.savepanel )
    ...
    if ~strcmpi( obj.textuiele.String, 'save as:' )
        set( obj.textuiele, 'string', 'save as:', 'foregroundcolor', 'b' );
